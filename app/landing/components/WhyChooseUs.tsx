      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="p-6 bg-gray-50 rounded-lg hover:shadow-md transition-shadow">
            ...
            <h3 className="font-bold text-lg mb-2 text-gray-900">Accurate</h3>
            <p className="text-gray-600">
          ...
          <div className="p-6 bg-gray-50 rounded-lg hover:shadow-md transition-shadow">
            ...
            <h3 className="font-bold text-lg mb-2 text-gray-900">Private</h3>
            <p className="text-gray-600">
          ...
          <div className="p-6 bg-gray-50 rounded-lg hover:shadow-md transition-shadow">
            ...
            <h3 className="font-bold text-lg mb-2 text-gray-900">Mobile-First</h3>
            <p className="text-gray-600">
          ...
          <div className="p-6 bg-gray-50 rounded-lg hover:shadow-md transition-shadow">
            ...
            <h3 className="font-bold text-lg mb-2 text-gray-900">Clear + Doctor-Ready</h3>
            <p className="text-gray-600">
          ...
          <div className="p-6 bg-gray-50 rounded-lg hover:shadow-md transition-shadow">
            ...
            <h3 className="font-bold text-lg mb-2 text-gray-900">Guaranteed Results</h3>
            <p className="text-gray-600">
