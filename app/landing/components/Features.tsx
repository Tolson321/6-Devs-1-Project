...
const Features = () => {
  return (
    <div id="features" className="py-16 px-4 md:px-8 scroll-mt-16">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="p-6 rounded-lg border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
            ...
            <h3 className="font-bold text-lg mb-2 text-gray-900">Human-Certified Doctor</h3>
          ...
          <div className="p-6 rounded-lg border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
            ...
            <h3 className="font-bold text-lg mb-2 text-gray-900">Insurance Claims</h3>
            <p className="text-gray-600">
          ...
          <div className="p-6 rounded-lg border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
            ...
            <h3 className="font-bold text-lg mb-2 text-gray-900">Technical Reviews</h3>
            <p className="text-gray-600">
