    ...
    <div className="py-16 px-4 md:px-8 bg-blue-600 text-white">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="flex flex-col md:flex-row gap-3 justify-center max-w-lg mx-auto">
          ...
          <Link 
            href="/" 
            className="bg-white text-blue-600 font-medium py-3 px-6 rounded-md hover:bg-gray-100 transition-colors whitespace-nowrap inline-flex items-center justify-center"
          >
            Try the App
          </Link>
        </div>
